...
export function trackProductView(productId) {
  ...
  userBehavior.viewedProducts = userBehavior.viewedProducts.filter((id) => id !== productId);
...
export function trackProductPurchase(productId) {
  ...
  userBehavior.purchasedProducts = userBehavior.purchasedProducts.filter((id) => id !== productId);
